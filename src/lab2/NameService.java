...
public class NameService {
    ...
    public String extractLastName(String fullName) throws IllegalArgumentException {
        ...
        if(nameParts.length < 2) {
            throw new IllegalArgumentException("Sorry you must provide both a first name and a last name");
        }
    ...
    public String extractFirstName(String fullName) throws IllegalArgumentException {
        ...
        String[] nameParts = fullName.split(" ");
        if(nameParts.length<2){
            throw new IllegalArgumentException("Sorry, you must provide both a first and a last name");
        }
